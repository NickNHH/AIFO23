...
def sendMessage():
    ...
    if data and 'message' in data:
        ...
        response = get_dialogflow_response('yt-chatbot-g99r', session_id, message, 'en')
...
def get_dialogflow_response(project_id, session_id, text, language_code):
    ...
    return {'query_result': response.query_result, 'response': format(response.query_result.fulfillment_text)}
